...
class FlavanoidsStatistics extends React.Component {
  ...
  calculateMean = (data, className) => {
    const classData = data.filter(item => item.Class === className);
    const flavanoidValues = classData.map(item => item.Flavanoids);
    const sum = flavanoidValues.reduce((acc, value) => acc + value, 0);
    return sum / flavanoidValues.length;
  }
  ...
  render() {
    const uniqueClasses = [...new Set(this.state.data.map(item => item.Class))];
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              {uniqueClasses.map(className => (
                <td key={className}>{this.calculateMean(this.state.data, className)}</td>
              ))}
            </tr>
            <tr>
              <td>Flavanoids - Median</td>
              {uniqueClasses.map(className => (
                <td key={className}>{this.calculateMedian(this.state.data, className)}</td>
              ))}
            </tr>
            <tr>
              <td>Flavanoids - Mode</td>
              {uniqueClasses.map(className => (
                <td key={className}>{this.calculateMode(this.state.data, className)}</td>
              ))}
            </tr>
          </tbody>
        </table>
